...
class ArcToolboxTests(unittest.TestCase):
    def test_atbx_is_the_arcgis_toolbox(self):
        ...
        self.assertIn("highlight_band", script)
        self.assertIn("dedupe_corrections", script)
        self.assertIn("accept_prompt_key", script)
        self.assertIn("_layer_line_width", script)
        self.assertIn("_HIGHLIGHT_TRANSPARENCY", script)
        self.assertIn("SelectLayerByAttribute", script)
        self.assertIn("SaveToLayerFile", script)
        self.assertIn("scratchGDB", script)
        self.assertNotIn("addDataFromPath", script)
